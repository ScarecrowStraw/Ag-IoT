...
//      uploadData();
      ...
      Process p;
      p.begin("/root/Test/Test2.sh");
      p.addParameter("22345");
      p.addParameter(data);  
      p.run();
     }
...
void uploadData() {//Upload Data to ThingSpeak
 ...
 p.begin("/root/Test/Test.sh");   //Script execution.In this example I use the script name is Test.
 p.addParameter("12345");
 p.addParameter("data");
 p.run();
